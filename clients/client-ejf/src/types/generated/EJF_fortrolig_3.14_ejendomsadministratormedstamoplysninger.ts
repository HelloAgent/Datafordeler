 ...
 */
export type PersonEllerVirksomhed = {
  type: "FeatureCollection";
  features: {
    type?: "Feature";
    properties?: {
 ...
 */
export type Personnummer1 = string;
/**
 * EAID_dst2034E8_04BE_4751_8DB1_C82BA391C3EF
 */
export type Status2 = "aktuel" | "fortrudt" | "historisk" | "rettet" | "teknisk_aendring";
/**
 ...
 */
export type Forretningshaendelse2 = string;
/**
 ...
 */
export type Forretningsproces2 = string;
/**
 ...
 */
export type RegistreringTil4 = string;
/**
 ...
 */
export type VirkningTil4 = string;
/**
...
/**
 * EAID_665E1A38_7A6A_41ab_A32B_B0DACA10757E
 */
export interface Personnummer {
  personnummer: Personnummer1;
  status: Status2;
}
/**
...
export interface FeatureAttributes2 {
  forretningshændelse?: Forretningshaendelse2;
