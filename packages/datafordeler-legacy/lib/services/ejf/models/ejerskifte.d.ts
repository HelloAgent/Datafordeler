...
export declare namespace Ejerskifte {
    ...
    type Forretningsproces = "Hændelse fra Digital Tinglysning" | "Konvertering fra ESR" | "Landsdækkende kørsel" | "Manuel opdatering" | "Hændelse fra CPR" | "Hændelse fra CVR" | "Opdatering fra Matriklen" | "Opdatering fra Skifte- eller Fogedret";
    type Overdragelsesmaade = "Almindelig fri handel" | "Almindelig fri handel særlige vilkår" | "Familieoverdragelse" | "Anden overdragelse" | "Interessesammenfald" | "Mageskifte" | "Ikke oplyst";
    interface Ejerskifte {
        id_namespace: string;
        id_lokalId: string;
